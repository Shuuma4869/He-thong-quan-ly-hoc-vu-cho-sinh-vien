...
Xem thêm tại [tài liệu dự án](docs/project-overview.md), [mô hình dữ liệu học vụ](docs/database-model.md), [nghiên cứu kết nối Phenikaa — Phase 3](docs/phenikaa-integration.md) và [hướng dẫn môi trường](docs/development-setup.md).
