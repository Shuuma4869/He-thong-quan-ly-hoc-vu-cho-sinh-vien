  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[260px_1fr]">
      ...
      <aside className="hidden border-r bg-card lg:flex lg:flex-col">
        ...
        <Link href="/settings" aria-current={pathname === "/settings" ? "page" : undefined} className="border-t p-5 text-sm text-primary">Cài đặt tài khoản</Link>
      </aside>
      <div className="min-w-0">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b bg-background/90 px-4 backdrop-blur lg:px-8">
          <Link href="/settings" className="text-sm font-medium lg:text-muted">Tài khoản AMS</Link>
